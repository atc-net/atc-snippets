function Set-DatabricksGlobalInitScript {
  ...
  Write-Host "  Checking for existing global init script called $initScriptName" -ForegroundColor DarkYellow
  ...
  if ($scriptId) {
    Write-Host "  Deleting existing global init script called $initScriptName" -ForegroundColor DarkYellow
